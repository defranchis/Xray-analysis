...
tag_styles = {
    'A FZ':                {"new tag": "New type A FZ",               "color": "black",      "marker": "o"},
    'B FZ':                {"new tag": "New type B FZ",               "color": "magenta",    "marker": "^"},
    'C FZ':                {"new tag": "New type C FZ",               "color": "darkorange", "marker": "D"},
    'D FZ':                {"new tag": "New Type D FZ",               "color": "blue",       "marker": "s"},
    'C EPI':               {"new tag": "New type C EPI",              "color": "darkorange", "marker": "D"},
    'D EPI':               {"new tag": "New Type D EPI",              "color": "blue",       "marker": "<"},
    'C FZ (Aug23)':        {"new tag": "New type C FZ (Aug23)",       "color": "darkorange", "marker": "v"},
    'C prime FZ (Aug23)':  {"new tag": "Type C prime FZ (Aug23)",     "color": "darkcyan",   "marker": ">"},
}
...
def getColorAndMarker(name):
    color = tag_styles[sampleNames[name]["leg"]]["color"]
    marker = tag_styles[sampleNames[name]["leg"]]["marker"]
    return color, marker
