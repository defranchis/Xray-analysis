...
sampleNames = {
    ...
    'N4789-12_UL' : {'leg': 'C EPI high dose',  'lw'  : 2, 'ls'  : 7, 'lc'  : ROOT.kOrange+2, 'ms' : ROOT.kOpenTriangleUp},
    'N4789-12_LR' : {'leg': 'C EPI low dose',   'lw'  : 2, 'ls'  : 7, 'lc'  : ROOT.kGray+3,   'ms' : ROOT.kOpenSquareDiagonal},
